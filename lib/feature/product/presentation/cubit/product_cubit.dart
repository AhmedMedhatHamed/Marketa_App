...
class ProductCubit extends Cubit<ProductState> {
  ...
  List<ProductModel> localProds = [
    ...
    ProductModel(
      ...
      productTitle: "Samsung Galaxy S21 Ultra 5G | Factory Unlocked Android Cell Phone | US Version 5G Smartphone",
      productPrice: "1199.99",
      productCategory: "Phones",
    ...
    ProductModel(
      ...
      productTitle: "OnePlus 9 Pro 5G LE2120 256GB 12GB RAM Factory Unlocked (GSM Only | No CDMA - not Compatible with Verizon/Sprint) International Version - Morning Mist",
    ...
    ProductModel(
      ...
      productPrice: "1199.99",
      productCategory: "Phones",
      productDescription: "A new, larger 6.7-inch size joins the popular 6.1-inch design, featuring a new dual-camera system, Crash Detection, a smartphone industry-first safety service with Emergency SOS via satellite, and the best battery life on iPhone",
    ...
    ProductModel(
      ...
      productImage: "https://i.ibb.co/sjH157B/32-Fjallraven-Kanken-Classic-Backpack.jpg",
